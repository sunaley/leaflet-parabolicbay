...
L.Util.extend(L.drawLocal.draw.toolbar.buttons, {
	polyline: 'Draw a polyline',
	polygon: 'Draw a polygon',
	rectangle: 'Draw a rectangle',
	circle: 'Draw a circle',
	marker: 'Draw a marker',
	parabolicbay: 'Draw a parabolic bay shape'
});

L.Util.extend(L.drawLocal.draw.handlers, {
	parabolicbay: {
 ...
 */
L.Draw.ParabolicBay = L.Draw.Feature.extend({
	statics: {
		TYPE: 'parabolicbay'
	},
