	...
	draw: {
		toolbar: {
			...
			buttons: {
				...
				parabolicbayshapes: 'Draw a polyline to set parabolic control points',
			}
		},
		handlers: {
			circle: {
            ...
            polyline: {
				error: '<strong>Error:</strong> shape edges cannot cross!',
				tooltip: {
					start: 'Click to start drawing line of up.',
                    cont: 'Click to continue drawing line.',
                    end: 'Click last point to finish line.'
				}
			}
...
/**
 * @class L.Draw.parabolicbayshapes
 * @aka Draw.parabolicbayshapes
 * @inherits L.Draw.Feature
 */
L.Draw.parabolicbayshapes = L.Draw.Feature.extend({
	statics: {
		TYPE: 'polyline'
	},
...
L.DrawToolbar = L.Toolbar.extend({
	...
	getModeHandlers: function (map) {
		return [
			...
			{
				enabled: this.options.parabolicbayshapes,
				handler: new L.Draw.parabolicbayshapes(map, this.options.parabolicbayshapes),
				title: L.drawLocal.draw.toolbar.buttons.parabolicbayshapes
			},
		];
	},
